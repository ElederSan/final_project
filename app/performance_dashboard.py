...
# STREAMLIT LAYOUT
#######################################
very_top_left,very_top_right = st.columns(2)
st.image("blank_space.jpg",width=300)
logo_column_left,logo_column_right = st.columns(2)
...
with very_top_left:
    st.header(":blue[Expondo] review dashboard")

with very_top_right:
    ""
with logo_column_left:
    st.image("expondo_logo.jpg",width=300)
